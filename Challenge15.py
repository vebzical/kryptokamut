...
kissa = b"ICE ICE BA"
value = PKCS7Pad(blocksize, kissa)
print(value)
try:
	print(PKCS7Strip(value, blocksize))
    #PKCS7Strip(b'ICE ICE BABY\x05\x05\x05\x05', blocksize)
    #PKCS7Strip(b'ICE ICE BABY\x01\x02\x03\x04', blocksize)
except PaddingError:
